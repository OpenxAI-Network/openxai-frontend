...
const tge: TGEManualToken[] = [
  ...
  // },
  // {
  //   account: "0x72230606639BB743Cc7C07FfebBE1F767a0eD2dB", // Stopped 25 September due to violation
  //   amount: 0.05 * totalSupply,
  //   atTGE: 0.5,
  //   vestingDays: 60,
  // },
  ...
  // },
  // {
  //   account: "0xdB330C2d29A26d93cF278ab808c5e11F94616b1f",
  //   amount: 0.5 * totalSupply,
  //   atTGE: 0.5,
  //   vestingDays: 60,
  // },
  ...
  // },
  // {
  //   account: "0x72CdDaE0Af577B052CF4070D73DE1c5FC4b36635",
  //   amount: 0.5 * totalSupply,
  //   atTGE: 0.5,
  //   vestingDays: 60,
  // },
  // {
  //   account: "0x0aE7356afc90b10eE35400dcCB9FBebAd2CB436D",
  //   amount: 0.5 * totalSupply,
  //   atTGE: 1,
  //   vestingDays: 0,
  // },
  ...
  // },
  // {
  //   account: "0x0eFa61AB978FafCa3ec83517c91B791E58556906",
  //   amount: 0.25 * totalSupply,
  //   atTGE: 0.5,
  //   vestingDays: 60,
  // },
  // {
  //   account: "0xa5574d507dC08c4E625fbD3A824c4cb1F4df8cf4",
  //   amount: 0.25 * totalSupply,
  //   atTGE: 0.5,
  //   vestingDays: 60,
  // },
  // {
  //   account: "0xb96443214a5dF3b4C6800912f2Cbf21B540233A0",
  //   amount: 0.25 * totalSupply,
  //   atTGE: 0.5,
  //   vestingDays: 60,
  // },
  // {
  //   account: "0x748d4D812aDDC7EA9b9309f34bA86e623fA73d3A",
  //   amount: 0.25 * totalSupply,
  //   atTGE: 0.5,
  //   vestingDays: 60,
  // },

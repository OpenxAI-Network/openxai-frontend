...
const PROTOCOL_METRICS = [
  ...
  },
  {
    ...
    value: "$0.008",
    tooltip:
      "The cost of running AI computations on OpenxAI compared to traditional cloud providers (AWS, GCP, Azure).",
  },
  {
    label: "Average Deployment Speed",
    value: "4 mins",
    tooltip:
      "Average time taken to deploy an AI model from upload to operational status.",
  },
  {
    label: "Censorship Resilience Rate (CRR)",
    value: "82%",
    tooltip:
      "Percentage of models immune to takedown by centralized authorities.",
  },
  {
    label: "No. of DAO Proposals",
    value: "21",
    tooltip:
      "Total number of governance proposals submitted by the OpenxAI community.",
  },
]
  ...
  <div>
    <div className="flex items-center gap-2">
      <div className="text-2xl font-bold text-white">
        {stat.value}
        {stat.change && (
          <span className="ml-1 text-sm font-normal text-[#CCCCCC]">
            ({stat.change})
          </span>
        )}
      </div>
  ...
  datasets: [
    {
      label: "Food",
      data: [
        10000, 15000, 20000, 25000, 22000, 20000, 18000, 15000, 12000, 10000,
        8000, 9000,
      ],
      borderColor: "#3384FF",
      borderWidth: 2,
    ...
    },
    {
      label: "Salary",
      data: [
        8000, 12000, 18000, 22000, 20000, 18000, 15000, 12000, 10000, 8000,
        7000, 8000,
      ],
      borderColor: "#FF00FF",
      borderWidth: 2,
...
const AI_MODELS: AIModel[] = [
  {
    logo: "https://studio.openxai.org/images/models/deepseek.png",
    name: "deepseek-r1",
  },
  { logo: "/logo/meta-logo.png", name: "llama2" },
  {
    logo: "https://studio.openxai.org/images/models/mistral.png",
    name: "mistral",
  },
  {
    logo: "https://studio.openxai.org/images/models/mistral.png",
  ...
  {
    logo: "https://studio.openxai.org/images/models/google.png",
    name: "gemma",
  },
  {
    logo: "https://studio.openxai.org/images/models/microsoft.png",
    name: "phi3",
  },
  { logo: "/logo/meta-logo.png", name: "codellama" },
  {
    logo: "https://studio.openxai.org/images/models/tinyllama.png",
    name: "tinyllama",
  },
  {
    logo: "https://studio.openxai.org/images/models/starcoder2.png",
    name: "starcoder2",
  },
  {
    logo: "https://studio.openxai.org/images/models/dolphin.png",
  ...
  {
    logo: "https://studio.openxai.org/images/models/qwen.png",
    name: "qwen2.5",
  },
  {
    logo: "https://studio.openxai.org/images/models/mistral.png",
  ...
  {
    logo: "https://studio.openxai.org/images/models/internlm.jpeg",
    name: "internlm2",
  },
  {
    logo: "https://studio.openxai.org/images/models/nvidia.png",
    name: "nemotron",
  },
  {
    logo: "https://studio.openxai.org/images/models/microsoft.png",
  ...
  {
    logo: "https://studio.openxai.org/images/models/codestral.png",
    name: "codestral",
  },
  {
    logo: "https://studio.openxai.org/images/models/starcoder2.png",
  ...
  {
    logo: "https://studio.openxai.org/images/models/ibm.png",
    name: "granite-code",
  },
  {
    logo: "https://studio.openxai.org/images/models/vicuna.png",
    name: "vicuna",
  },
  {
    logo: "https://studio.openxai.org/images/models/smollm2.png",
    name: "smollm",
  },
  {
    logo: "https://studio.openxai.org/images/models/wizard-vicuna-uncensored.png",
  ...
  {
    logo: "https://studio.openxai.org/images/models/codegeex4.jpg",
    name: "codegeex4",
  },
  {
    logo: "https://studio.openxai.org/images/models/openchat.png",
    name: "openchat",
  },
  ...
  {
    logo: "https://studio.openxai.org/images/models/nous.png",
    name: "nous-hermes2",
  },
]
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-white md:text-4xl">
                      {DONUT_DATA.totalTokens}
                    </div>
                    <div className="text-sm text-[#6A6A6A] md:text-base">
                      Total Tokens
                    </div>
                  </div>
                </div>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="mt-1 text-lg text-[#6A6A6A]">
                  ...
                  protocol, infrastructure, products, tools, and upgrading the
                  protocol.
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="mt-1 text-lg text-[#6A6A6A]">
                  ...
                  early ecosystem bootstrap funding.
                </div>
              </div>
            </div>
          </div>
                ...
                datasets: [
                  {
                    ...
                    data: [
                      2.5, 5, 7.5, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10,
                      10, 10, 10, 10, 10, 10,
                    ],
                    borderColor: "#00FF94",
                    fill: true,
                  ...
                  },
                  {
                    ...
                    data: [
                      3, 6, 9, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12,
                      12, 12, 12, 12, 12,
                    ],
                    borderColor: "#FFCC00",
                    fill: true,
                  ...
                  },
                  {
                    ...
                    data: [
                      1.2, 3.6, 4.8, 6, 7.2, 8.4, 9.6, 10.8, 12, 13.2, 14.4,
                      15.6, 16.8, 18, 19.2, 20.4, 21.6, 22.8, 24, 24,
                    ],
                    borderColor: "#9933FF",
                    fill: true,
                  ...
                  },
                  {
                    ...
                    data: [
                      0, 0, 0.9, 1.8, 2.7, 3.6, 4.5, 5.4, 6.3, 7.2, 8.1, 9, 9.9,
                      10.8, 11.7, 12.6, 13.5, 14.4, 14.4, 14.4,
                    ],
                    borderColor: "#FF00FF",
                    fill: true,
                  ...
                  },
                  {
                    ...
                    data: [
                      2.08, 3.64, 5.2, 6.76, 8.32, 9.88, 11.44, 13, 14.56,
                      16.12, 17.68, 19.24, 20.8, 22.36, 23.92, 25.48, 26, 26,
                      26, 26,
                    ],
                    borderColor: "#3384FF",
                    fill: true,
